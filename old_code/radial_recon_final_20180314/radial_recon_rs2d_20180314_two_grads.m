...
expno = 2432; %% Determines which experiment you are using, evenutally,
...
tic
senscor = senscor_gen_20180314(recon_matrix_size, nsample, nspokes1, filter, filter2, x_grad, y_grad, z_grad, data_path);
